...
namespace WKUdyr
{
    public static class Program
    {
        ...
        public const string ChampName = "Udyr";
        ...
        private static void OnDraw(EventArgs args)
        {
            ...
            var x = Drawing.WorldToScreen(Player.Instance.Position);

            if (Settings.PheonixMode)
            {
                Drawing.DrawText(x.X - 35, x.Y + 60, System.Drawing.Color.Orange, "Pheonix Mode");

            }
            else if(Settings.TigerMode)
            {
                Drawing.DrawText(x.X - 35, x.Y + 60, System.Drawing.Color.LightYellow, "Tiger Mode");
